...
<xsl:stylesheet xmlns:emo="http://www.w3.org/2009/10/emotionml"
    xmlns:helpers="xalan://emotionml.xslt.Helpers" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    exclude-result-prefixes="emo helpers" version="1.0" xmlns="http://mary.dfki.de/2002/MaryXML">
    ...
    <xsl:template
        match="emo:emotion[emo:category and helpers:expressedThrough(., 'voice', true())]">
        ...
        <xsl:choose>
            <xsl:when test="$voice='dfki-pavoque-styles'">
                <xsl:variable name="style">
                    <xsl:choose>
                        <xsl:when
                            test="helpers:declaredCategoryVocabulary(.) = 'http://www.w3.org/TR/emotion-voc/xml#big6'">
                            <xsl:choose>
                        ...
                        <xsl:when
                            test="helpers:declaredCategoryVocabulary(.) = 'http://www.w3.org/TR/emotion-voc/xml#everyday-categories'">
                            <xsl:choose>
    ...
    <xsl:template match="emo:emotion[emo:dimension]">
        <xsl:choose>
            <xsl:when
                test="helpers:declaredDimensionVocabulary(.) = 'http://www.w3.org/TR/emotion-voc/xml#pad-dimensions'">
            ...
            <xsl:when
                test="helpers:declaredDimensionVocabulary(.) = 'http://www.w3.org/TR/emotion-voc/xml#fsre-dimensions'">
                <xsl:variable name="arousal" select="emo:dimension[@name='arousal']/@value" />
