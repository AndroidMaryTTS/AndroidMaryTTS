...
function requestSynthesis()
{
	...
	param = param + '&prosody_rate' + "=" + encodeURIComponent(trim(document.getElementById('prosody_rate').value));
	
	
if (document.getElementById('seperateParagraph').checked) {
    		param = param + '&seperateParagraph' + "=" + encodeURIComponent(trim(document.getElementById('seperateParagraph').value));
        }
	if(document.getElementById('seperate_prosody').value.length != 0)	
	     param = param + '&seperate_prosody' + "=" + encodeURIComponent(trim(document.getElementById('seperate_prosody').value));
