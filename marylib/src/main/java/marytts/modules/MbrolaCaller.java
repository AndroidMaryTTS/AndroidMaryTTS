...
public class MbrolaCaller extends SynthesisCallerBase {
    ...
    public MbrolaCaller() throws NoSuchPropertyException {
        ...
        Log.d(Mary.LOG, "Found mbrola binary in " + baseCmd);
    ...
    public AudioInputStream synthesiseOneSection(String mbrolaData, Voice voice) throws IOException {
        ...
        do {
            ...
            Log.d(Mary.LOG, "Keeping audio data in " + (audioDestination.isInRam() ? "RAM" : " a temp file"));
            StringBuilder cmdString = new StringBuilder();
            for (int i = 0; i < cmd.length; i++) {
                cmdString.append(cmd[i]);
                cmdString.append(" ");
            }
            Log.i(Mary.LOG, "Starting Synthesis with command: " + cmdString.toString().trim());
            ...
            Log.d(Mary.LOG, "Writing MBROLA input:\n" + mbrolaData + "\n");
            ...
            do {
                try {
                    ...
                    Log.w(Mary.LOG, "Unexpected interruption while waiting for reader thread.");
                }
            ...
            Log.w(Mary.LOG, "Timeout occurred in attempt " + nrAttempts + " out of " + MAX_NR_ATTEMPTS);
