...
public class AllophoneSet {
    ...
    private AllophoneSet(InputStream inputStream)
        ...
        try {
            ...
            Log.d(Mary.LOG, "Cannot parse allophone file" + e.toString());
...
//        }
    ...
    public static AllophoneSet getAllophoneSet(String filename)
        ...
        try {
            ...
            Log.d(Mary.LOG, "Problem reading allophone file " + filename + " " + e.toString());
    ...
    public static AllophoneSet getAllophoneSet(InputStream inStream, String identifier)
        ...
        if (as == null) {
            ...
            try {
                ...
                Log.d(Mary.LOG, "Problem loading allophone set from " + identifier + " " + e.toString());
     ...
     *
     * @param ph name of Allophone to get
