...
public class ModuleRegistry {
    ...
    public static MaryModule instantiateModule(String moduleInitInfo)
        ...
        Log.i(Mary.LOG, "Now initiating mary module '" + moduleInitInfo + "'");

        MaryModule m = (MaryModule) MaryRuntimeUtils.instantiateObject(moduleInitInfo);
        //Log.i(Mary.LOG,"Module '"+moduleInitInfo+" finished process initialisation. ");
        return m;
    }
    ...
    private static LinkedList<MaryModule> modulesRequiredForProcessing(
        ...
        if (sourceType.equals(targetType)) {
            Log.d(Mary.LOG, "found path through modules");
