...
public class MaryXMLToMbrola extends InternalModule {
    ...
    public MaryData process(MaryData d)
        ...
        if (currentVoice == null) {
            ...
            Log.i(Mary.LOG, "No default voice associated with data. Assuming locale " + locale + " default " +
            ...
            if (element.getTagName().equals(MaryXML.PHONE)) {
                ...
                if (duration != null && !duration.equals("")) {
                    try {
                        ...
                        Log.d(Mary.LOG, "Unexpected value for duration: '" + duration + "' -- ignoring boundary");
                    }
                }
            } else {
