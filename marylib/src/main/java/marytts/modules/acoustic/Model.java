...
public abstract class Model {
     ...
     * Model constructor
     *
     * @param featureManager        the feature processor manager used to compute the symbolic
     *                              features used for prediction
     * @param dataFileName          data file for this Model
     * @param targetAttributeName   attribute in MaryXML to predict
     * @param targetAttributeFormat printf-style format String to specify the attribute value,
     *                              i.e. "%.3f" to round to 3 decimal places; "%s" by default
     * @param featureName           name of the custom continuous feature predicted by this model,
     *                              or null
     * @param predictFrom           key of Element Lists from which to predict values; "segments"
     *                              by default
     * @param applyTo               key of Element Lists to which to apply values; "segments" by
     *                              default
     */
     ...
     * Elements
     *
     * @param elements Elements for which to predict the values
     * @throws MaryConfigurationException if attribute values cannot be predicted because of an invalid
     *                                    voice configuration
     */
     ...
     * of Elements
     *
     * @param predictFromElements Elements from which to predict the values
     * @param applyToElements     Elements to which to apply the values predicted by this Model
     * @throws MaryConfigurationException if attribute values cannot be predicted because of an invalid
     *                                    voice configuration
     */
     ...
     * @param target
     * @return target value
     * @throws Exception if the target value cannot be predicted
     */
