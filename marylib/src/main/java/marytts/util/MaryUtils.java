...
//        return Logger.getLogger(MaryUtils.class);
//       // return Logger.getLogger(MainActivity.class);
//    }
//
//    /*
//     * Provide a Logger object whose name is built from MaryUtils.LOGPREFIX and the given nameSuffix.    System.out.println(System.getProperties());
//     * @param nameSuffix the suffix to use for the logger name.    System.out.println(System.getProperties());
//     * @return    System.out.println(System.getProperties());
//     */
