...
public class MaryRuntimeUtils {
    ...
    public static Object instantiateObject(String objectInitInfo)
        ...
        try {
            ...
            Log.d(Mary.LOG, "Cannot instantiate object from '" + objectInitInfo + "': " + MaryUtils.getFirstMeaningfulMessage(e));
     ...
     * still available for processing. "Available" memory is calculated using
     * <code>availableMemory()</code>.The threshold value can be specified
     * as the Mary property mary.lowmemory (in bytes). It defaults to 20000000 bytes.instantiateModule
     *
    ...
    public static AllophoneSet needAllophoneSet(String propertyName)
        ...
        //Log.d(Mary.LOG,"needAllophoneSet, propertyName="+propertyName+" propertyValue="+propertyValue);

        if (propertyValue == null) {
            Log.d(Mary.LOG, "No such property: " + propertyName);
        ...
        try {
            ...
            Log.d(Mary.LOG, "1 Cannot open allophone stream for property " + propertyName);
