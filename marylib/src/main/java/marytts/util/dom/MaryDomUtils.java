...
public class MaryDomUtils extends DomUtils {
    ...
    public static boolean isSchemaValid(Document doc)
        ...
        try {
            ...
            Log.d(Mary.LOG, "Cannot serialize document for Schema-valid parsing" + te);
        ...
        try {
            ...
            Log.d(Mary.LOG, "Problem setting up parser" + pce);
            throw new MaryConfigurationException("Problem setting up parser", pce);
        } catch (IOException ioe) {
            Log.d(Mary.LOG, "IOException should not occur but it does" + ioe);
