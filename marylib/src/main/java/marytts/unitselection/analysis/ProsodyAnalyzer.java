...
public class ProsodyAnalyzer {
     ...
     *
     * @param units      whose predicted and realized prosody to analyze
     * @param sampleRate of the unit database, in Hz
     * @throws Exception if the units cannot be parsed into phones
     */
     ...
     * @throws Exception if the predicted prosody cannot be determined properly
     */
     ...
     * @throws Exception if Document cannot be accessed
     */
    private NodeList getPhoneNodes() throws Exception {
        ...
        try {
            ...
            Log.d(Mary.LOG, new Exception("Could not access the Document!", e).toString());
    ...
    public List<Double> getDurationFactors() {
        ...
        for (Phone phone : phones) {
            ...
            if (leftDurationFactor > 0) {
                ...
                Log.d(Mary.LOG, "duration factor for unit " + phone.getLeftUnit().getTarget().getName() + " -> "
                        + leftDurationFactor);
            }
            ...
            if (rightDurationFactor > 0) {
                ...
                Log.d(Mary.LOG, "duration factor for unit " + phone.getRightUnit().getTarget().getName() + " -> "
                        + rightDurationFactor);
            }
        }
     ...
     * </ul>
     *
     * @param fileName of the DurationTier to be generated
     * @throws IOException
     */
     ...
     *
     * @param fileName of the PitchTier to be generated
     * @throws IOException
     */
