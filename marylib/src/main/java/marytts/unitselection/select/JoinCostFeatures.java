...
public class JoinCostFeatures implements JoinCostFunction {
     ...
     */
    public static Object[] readJoinCostWeightsFile(String fileName) throws IOException {
     ...
     * @param fileName the text file containing the join weights
     * */
    public static Object[] readJoinCostWeightsStream(InputStream weightStream) throws IOException {
    ...
    private void loadFromByteBuffer(String joinFileName, InputStream weightStream, String precompiledCostFileName, float wSignal)
        ...
        try {
            ...
            if (weightStream != null) {
                Log.d(Mary.LOG, "Overwriting join cost weights");
