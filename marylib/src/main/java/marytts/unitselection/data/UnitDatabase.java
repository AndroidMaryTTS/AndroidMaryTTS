...
public class UnitDatabase {
    ...
    public List<ViterbiCandidate> getCandidates(Target target) {
        ...
        Log.d(Mary.LOG, "For target " + target + ", selected " + clist.length + " units");
    ...
    public String getFilenameAndTime(Unit unit) {
        ...
        try {
            ...
            Log.w(Mary.LOG, "Problem getting filename and time for unit " + unit.index + " at time " + unit.startTime, e);
...
//       if (basenameTimeline == null) return "unknown origin";
        try {
            ...
            Log.w(Mary.LOG, "Problem getting filename for unit " + unit.index, e);
            return "unknown origin";
        }
    }
