...
public class MaryDataType {
    ...
    public static String getExampleText(MaryDataType type, Locale locale) {
        ...
        InputStream exampleStream = null;
        if (locale == null) {
            try {
                exampleStream = MaryLink.getContext().getAssets().open("marytts/datatypes/" + type.name() + ".example");
            } catch (Exception e) {
            ...
            try {
                exampleStream = MaryLink.getContext().getAssets().open("marytts/language/" + locale.toString() + "/datatypes/" + type.name() + "." + locale.toString() + ".example");
            } catch (Exception e) {
                Log.i(Mary.LOG, e.getMessage());
            }
        }
        ...
        try {
            ...
            Log.d(Mary.LOG, "Could not get example text for " + type.name() + " / locale " + locale);
            return null;
        }
    }
