...
public class HntmSpeechFrame extends BaseSinusoidalSpeechFrame {
    ...
    public HntmSpeechFrame(DataInputStream dis, int noiseModel) throws IOException {
        this();
    ...
    public HntmSpeechFrame(ByteBuffer bb, int noiseModel) throws IOException {
        this();
    ...
    public boolean equals(HntmSpeechFrame other) {
        ...
        return deltaAnalysisTimeInSeconds == other.deltaAnalysisTimeInSeconds;
