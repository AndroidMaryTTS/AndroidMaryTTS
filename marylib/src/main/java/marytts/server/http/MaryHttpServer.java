...
public class MaryHttpServer extends Thread {
    ...
    public void run() {
        ...
        Log.i(Mary.LOG, "Waiting for client to connect on port " + localPort);
        ...
        try {
            ...
            Log.i(Mary.LOG, "Interrupted", ex);
        } catch (IOException e) {
            Log.i(Mary.LOG, "Problem with HTTP connection", e);
        }
        Log.d(Mary.LOG, "Shutdown");
    }
    ...
    static class EventLogger implements EventListener {
        ...
        public void connectionTimeout(final NHttpConnection conn) {
            Log.i(Mary.LOG, "Connection timed out: " + conn);
        }

        @Override
        public void connectionClosed(final NHttpConnection conn) {
            Log.i(Mary.LOG, "Connection closed: " + conn);
        }

        @Override
        public void fatalIOException(final IOException ex, final NHttpConnection conn) {
            Log.i(Mary.LOG, "I/O error: " + ex.getMessage());
        }

        @Override
        public void fatalProtocolException(final HttpException ex, final NHttpConnection conn) {
            Log.i(Mary.LOG, "HTTP error: " + ex.getMessage());
        }
    }
}
