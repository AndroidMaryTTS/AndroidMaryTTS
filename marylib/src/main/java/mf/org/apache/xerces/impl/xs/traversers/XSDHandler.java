...
public class XSDHandler {
            ...
            if (referType != XSDDescription.CONTEXT_PREPARSE) {
                ...
                if (!isDocument) {
                    if (streamReader != null) {
                        isDocument = (streamReader.getEventType() == XMLStreamConstants.START_DOCUMENT);
                    } else {
    ...
    private XSDocumentInfo findXSDocumentForDecl(XSDocumentInfo currSchema,
        ...
        if (DEBUG_NODE_POOL) {
            System.out.println("DOCUMENT NS:" + currSchema.fTargetNamespace + " hashcode:" + currSchema.fSchemaElement.hashCode());
        }
