...
class DurationImpl
    ...
    public int compare(Duration rhs) {
        ...
        GregorianCalendar lhsCalendar = new GregorianCalendar(
                ...
                0,
                0);
        lhsCalendar.add(Calendar.YEAR, getYears() * getSign());
        lhsCalendar.add(Calendar.MONTH, getMonths() * getSign());
        lhsCalendar.add(Calendar.DAY_OF_YEAR, getDays() * getSign());
        lhsCalendar.add(Calendar.HOUR_OF_DAY, getHours() * getSign());
        lhsCalendar.add(Calendar.MINUTE, getMinutes() * getSign());
        lhsCalendar.add(Calendar.SECOND, getSeconds() * getSign());
        ...
        GregorianCalendar rhsCalendar = new GregorianCalendar(
                ...
                0,
                0);
        rhsCalendar.add(Calendar.YEAR, rhs.getYears() * rhs.getSign());
        rhsCalendar.add(Calendar.MONTH, rhs.getMonths() * rhs.getSign());
        rhsCalendar.add(Calendar.DAY_OF_YEAR, rhs.getDays() * rhs.getSign());
        rhsCalendar.add(Calendar.HOUR_OF_DAY, rhs.getHours() * rhs.getSign());
        rhsCalendar.add(Calendar.MINUTE, rhs.getMinutes() * rhs.getSign());
        rhsCalendar.add(Calendar.SECOND, rhs.getSeconds() * rhs.getSign());
    ...
    public Number getField(DatatypeConstants.Field field) {
         ...
         */
        String methodName = "mf.javax.xml.datatype.Duration" + "#(getSet(DatatypeConstants.Field field)";
