...
public class DOMSerializerImpl implements LSSerializer, DOMConfiguration {
    ...
    static class DocumentMethods {
        ...
        static {
            try {
                fgDocumentGetXmlVersionMethod = Document.class.getMethod("getXmlVersion");
                fgDocumentGetInputEncodingMethod = Document.class.getMethod("getInputEncoding");
                fgDocumentGetXmlEncodingMethod = Document.class.getMethod("getXmlEncoding");
