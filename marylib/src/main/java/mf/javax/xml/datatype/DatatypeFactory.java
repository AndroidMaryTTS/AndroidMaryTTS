...
public abstract class DatatypeFactory {
     ...
     */
    public static final String DATATYPEFACTORY_PROPERTY = "mf.javax.xml.datatype.DatatypeFactory";
    ...
    public XMLGregorianCalendar newXMLGregorianCalendar(
        ...
        if (millisecond != DatatypeConstants.FIELD_UNDEFINED) {
            if (millisecond < 0 || millisecond > 1000) {
                throw new IllegalArgumentException(
                        "mf.javax.xml.datatype.DatatypeFactory#newXMLGregorianCalendar("
    ...
    public XMLGregorianCalendar newXMLGregorianCalendarTime(
        ...
        if (milliseconds != DatatypeConstants.FIELD_UNDEFINED) {
            if (milliseconds < 0 || milliseconds > 1000) {
                throw new IllegalArgumentException(
                        "mf.javax.xml.datatype.DatatypeFactory#newXMLGregorianCalendarTime("
